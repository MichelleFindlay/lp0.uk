...
<a className="flex items-center transition-all hover:text-neutral-800 dark:hover:text-neutral-100" rel="noopener noreferrer" target="_blank" href="https://lp0nfire.medium.com/social-exodus-into-the-fediverse-3568119350b4"><ArrowIcon /><p className="ml-2 h-7">View Post on Medium</p></a>
